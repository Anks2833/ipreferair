...
import { DatePicker, TimePicker } from 'antd'; // Import DatePicker from Ant Design for date selection.
import dayjs from 'dayjs'; // Import dayjs for managing and formatting dates.
import { useEffect, useRef, useState } from 'react'; // Import necessary React hooks for managing component state and effects.
...
const AirportToHotel = () => {
	...
	const [isDestinationListVisible, setIsDestinationListVisible] =
		useState(false); // For toggling the destination list visibility.
	...
	const [states] = useState([
		// Predefined list of states used for the destination and origin suggestions.
		'California',
		'Texas',
		'Florida',
		'New York',
