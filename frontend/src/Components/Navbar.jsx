			...
			>
				...
				<nav className='flex flex-col space-y-8 mt-4 justify-center items-center overflow-auto'>
					...
					{currentUser ? (
						...
						>
							{/* Sign-in button */}
							<button className='rounded-full border border-[#48aadf] text-gray-500 font-semibold px-10 py-2 cursor-pointer'>
								Sign in
							</button>
						</Link>
					)}
				...
				{languageModal && (
					<motion.div
						...
						<motion.div
							...
							transition={{
								duration: 0.5, // Duration for the transition effect
