...
import { destinations } from '../Data/Locations.jsx'; // Import destination data.
...
const Destinations = () => {
	...
	const [destinationScroll, setDestinationScroll] = useState({
		prev: false,
		next: true,
	}); // State to manage the visibility of the scroll buttons.
