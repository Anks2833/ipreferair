	...
	return (
		<motion.div
			...
			<form
				...
				className='pt-16 w-[30rem] max-w-[90%] flex flex-col gap-5'>
				{/* Back button */}
				<div
				...
				<p className='text-sm'>
					Your new email will be used for all communications regarding your
					bookings, account updates, and other important information. Please
					ensure it's correct.
				</p>
