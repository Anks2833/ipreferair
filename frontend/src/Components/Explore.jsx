...
import { explore } from '../Data/Locations.jsx'; // Data source containing location information
...
const Explore = () => {
	...
	const [exploreScroll, setExploreScroll] = useState({
		prev: false,
		next: true,
	}); // State to manage scroll navigation buttons
					...
					<div
						...
						<div className='img-box'>
							...
							<div
								...
								style={{
									transform: `translateX(-${activeImages[i] * 100}%)`,
								}} // Slide based on active image index
							>
						...
						>
							...
							<div className='flex flex-col gap-1'>
								...
								<div className='text-sm '>{explore.newPrice} total</div>
