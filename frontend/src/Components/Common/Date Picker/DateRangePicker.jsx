...
const DateRangePicker = ({ onDateChange, defaultDates }) => {
	...
	const handleDateChange = (selectedDates) => {
		if (selectedDates?.length === 2) {
			// Check if two dates are selected (start and end dates)
	...
	return (
		<div className='border rounded-xl p-3 flex items-center flex-1'>
			{' '}
			{/* Wrapper div for styling the component */}
			<FaRegCalendarAlt className='text-xl' />{' '}
			{/* Calendar icon, adds visual representation */}
			<div className='w-full h-full relative'>
				{' '}
				{/* Container for the DatePicker input field */}
