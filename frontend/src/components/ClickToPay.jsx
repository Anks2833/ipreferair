      ...
      */}
        ...
        */}
          ...
          */}
					...
					<img
						src={`${import.meta.env.PUBLIC_URL}/images/master-card.png`}
						alt='Mastercard'
						className='w-12'
					/>
					{/* 
          ...
          */}
					...
					<img
						src={`${import.meta.env.PUBLIC_URL}/images/verve.svg`}
						alt='Verve'
						className='w-16'
					/>
					{/* 
          ...
          */}
				...
				<p>
					Click-to-Pay is a secure way to pay online, powered by the global
					payments industry.
				</p>
				{/* 
        ...
        */}
				...
				<p>
					Add cards from participating networks to simply and securely use them
					wherever Click-to-Pay is supported.
				</p>
				{/* 
