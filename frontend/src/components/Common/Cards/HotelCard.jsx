...
const HotelCard = ({ hotel, hotelName, cancelBooking }) => {
    ...
    return (
			<div className='rounded-xl bg-blue-100 flex flex-col justify-between gap-5 h-fit shadow shadow-white'>
				{/* Image Slider Container */}
				<div className='relative z-10 sm:min-w-72 sm:max-w-72 min-w-[50%] rounded-xl sm:h-60 h-40 overflow-hidden'>
				...
				<div className='flex flex-col gap-2 p-4'>
					...
					<p className='text-lg font-semibold text-wrap text-start max-sm:text-[0.78rem] leading-tight'>
						...
						{/* Formatting hotel name or using default */}
					</p>
