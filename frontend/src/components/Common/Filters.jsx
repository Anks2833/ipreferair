		...
		<div className='flex flex-wrap gap-5 w-full items-start justify-between'>
			...
			<div className='flex flex-col gap-2 w-64 max-w-full'>
				<label
					...
					{/* Displaying current price range value */}
				</label>
				<input
					type='range'
					id='price-range'
			...
			<div className='flex flex-col gap-2 font-[400]'>
				<label className=' font-semibold'>Number of Stops</label>{' '}
				{/* Label for stops filter */}
			...
			<div className='flex flex-col gap-2 font-[400]'>
				<label className=' font-semibold'>Travel and Baggage</label>{' '}
				{/* Label for baggage options */}
					...
					{[
						...
						renderCheckbox(
							...
							() =>
								...
								})), // Toggle baggage option on click
			...
			<div className='relative w-fit font-normal'>
