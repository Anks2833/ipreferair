		...
		<div>
			<div className='flex flex-col gap-5'>
				...
				<div className='flex sm:items-center gap-5 max-sm:flex-col'>
					...
					<div className='grid sm:grid-cols-3 grid-cols-2 items-center gap-3 text-[0.75rem] text-nowrap w-fit text-[#000000e3] relative  font-semibold'>
						...
						<p
							className={`py-2 px-4 w-fit border cursor-pointer rounded-full transition-all duration-500 ease-in-out 
                                ${
																	visible === 'airport-to-hotel' &&
																	'bg-blue-100'
																}`} // Add bg-blue-100 class if the tab is selected
				...
				{/* Show the AirportToHotel component when 'airport-to-hotel' is selected */}
				{visible === 'hotel-to-airport' && <HotelToAirport />}{' '}
				{/* Show the HotelToAirport component when 'hotel-to-airport' is selected */}
				{visible === 'round-trip' && <CarRoundTrip />}{' '}
				{/* Show the CarRoundTrip component when 'round-trip' is selected */}
			</div>
		</div>
	);
};
