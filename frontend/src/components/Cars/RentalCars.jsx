				...
				<div className='border rounded-xl p-3 flex items-center'>
					...
					<div className='w-full h-full relative'>
						<label
							...
							className='absolute left-3 text-sm text-nowrap cursor-text top-[0.1rem] scale-75 -translate-x-3 transform -translate-y-1/2'>
							Pick up time
						</label>
						<TimePicker
							id='pick-up-time'
				...
				<div className='border rounded-xl p-3 flex items-center'>
					...
					<div className='w-full h-full relative'>
						<label
							...
							className={`absolute left-3 text-sm cursor-text top-[0.1rem] scale-75 -translate-x-3 transform -translate-y-1/2 text-nowrap`}>
							Drop off time
						</label>
						<TimePicker
							id='drop-off-time'
