		...
		switch (field) {
			...
			case 'securityCode':
				return /^\d{3,4}$/.test(value)
					? ''
					: 'Security code must be 3 or 4 digits.'; // Check security code format.
			default:
				return '';
		}
	};
	...
	return (
		<div className='flex flex-col'>
			...
			<div className='flex gap-4 items-center'>
				{/* Mastercard logo */}
				<img
					src={`${import.meta.env.VITE_PUBLIC_URL}/images/master-card.png`}
					alt='Mastercard'
					className='w-12'
				/>
				{/* Visa logo */}
				...
				{/* Verve logo */}
				<img
					src={`${import.meta.env.VITE_PUBLIC_URL}/images/verve.svg`}
					alt='Verve'
					className='w-16'
				/>
			</div>
			...
			<div className='flex flex-col gap-4 py-5'>
				...
				<div className='flex flex-col gap-1 w-fit'>
					...
					{errors.cardName && (
						<p className='text-red-500 text-[0.7rem]'>{errors.cardName}</p>
					)}
				</div>
				...
				<div className='flex flex-col gap-1 w-fit'>
					...
					{errors.cardNumber && (
						<p className='text-red-500 text-[0.7rem]'>{errors.cardNumber}</p>
					)}
				</div>
				...
				<div className='flex flex-col gap-1'>
					...
					<div className='flex items-center gap-4'>
						...
						<input
							...
							maxLength={2}
							value={
								formData.paymentCard?.expirationDate === 'Not provided'
									? ''
								...
								handleValidation({
									target: {
										...
										value: `${e.target.value}/${
											formData.paymentCard?.expirationDate?.split('/')[1] || ''
										}`,
									},
								});
							}}
				...
				<div className='flex flex-col gap-1'>
					...
					{errors.securityCode && (
						<p className='text-red-500 text-[0.7rem]'>{errors.securityCode}</p>
					)}
				</div>
			</div>
