			...
			<div className='w-full bg-blue-100 shadow shadow-[#48aadf] p-5 rounded-3xl flex flex-col lg:w-1/3'>
				...
				<div className='py-3 border-b-2 border-white'>
					...
					<p className='font-medium'>
						...
						{hotelDetails?.data[0]?.hotel?.cityCode}
					</p>
					...
					<p className='text-sm'>
						...
						Arrives at{' '}
						{formatTime(
							hotelDetails?.data[0].offers[0]?.policies?.cancellations[0]
								?.deadline
						)}
					</p>
				</div>
				...
				<div className='flex flex-col gap-2 pt-3'>
					...
					<div>
						...
						{hotelDetails?.data[0].offers[0]?.guests?.adults > 1
							? 'Adults'
							: 'Adult'}
					</div>
					...
					<p className='text-xl font-semibold'>
						{total.toFixed(2)}{' '}
						{hotelDetails?.data[0].offers[0]?.price?.currency}
					</p>
				</div>
			</div>
		</motion.div>
