...
import {
	...
	updateStart,
	updateSuccess,
} from '../redux/user/userSlice'; // Redux actions for user updates
				...
				<div className='w-full flex-1 p-6 bg-blue-100 shadow shadow-[#48aadf] rounded-3xl flex flex-col gap-5'>
					...
					<div className='flex flex-col gap-4'>
							...
							<div className='flex flex-col lg:flex-row gap-5 fl'>
								...
								<div className='flex flex-col gap-1'>
									...
									<input
										...
										value={
											formData.number !== 'Not provided' ? formData.number : ''
										}
                      ...
                      ${
                        ...
                        ${receiveSMS ? 'opacity-100' : 'opacity-0'}`}
											viewBox='0 0 24 24'
											fill='none'
											stroke='currentColor'
											strokeWidth='3'>
						...
						<div className='flex flex-col gap-1'>
							{/* Passport input */}
							<h2 className='font-medium text-sm'>Passport</h2>
							<div className='relative w-fit'>
								{/* Chevron Down Icon for the dropdown */}
								<ChevronDown className='absolute right-3 p-1 top-1/2 transform -translate-y-1/2 pointer-events-none' />
								<select
						...
						<div className='flex flex-col gap-1'>
							<h2 className='text-sm font-medium'>Date of Birth</h2>
						...
						<div className='flex flex-col gap-1 mt-5'>
							...
							<div className='flex flex-col gap-2 relative'>
								...
								<div
									className='relative flex items-center text-[0.915rem] text-nowrap w-fit text-sm font-semibold text-[#000000e3] '
									ref={tabContainerRef}>
									{/* Debit card option */}
									<p
            ...
            On larger screens, the width is set to 1/3 using Tailwind's lg:w-1/3 class, and it takes up full width on smaller screens. */}
				...
				<div className='py-3 border-b-2 border-white'>
					...
					<p className='font-medium'>
						...
						{formatWord(flight.itineraries[0].segments[0].departure.iataCode)})
						to
						{formatWord(
							flight.itineraries[0].segments.slice(-1)[0].arrival.cityName
						)}{' '}
						({formatWord(flight.itineraries[0].segments[0].arrival.iataCode)})
